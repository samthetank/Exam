!function(t,e,i){
    ...
    i._checkTransition();
    var n=function(e){
        e||(e={}),this.queue=[],this.baseCls=e.baseCls||"humane",this.addnCls=e.addnCls||"",this.timeout="timeout"in e?e.timeout:2500,this.waitForMove=e.waitForMove||!1,this.clickToClose=e.clickToClose||!1,this.container=e.container;
        try{
            this._setupEl()
        }catch(n){
    ...
    return n.prototype={
        ...
        _setupEl:function(){
            ...
            t.style.display="none",this.container||(this.container=e.body),this.container.appendChild(t),this.el=t,this.removeEvent=i.bind(this.remove,this),this.transEvent=i.bind(this._afterAnimation,this),this._run()
        },
        ...
        _setOpacity:function(t){
            i.useFilter?this.el.filters.item("DXImageTransform.Microsoft.Alpha").Opacity=100*t:this.el.style.opacity=t+""
        },
        _showMsg:function(){
        ...
        log:function(t,e,i,n){
            ...
            if(n)for(var o in n)s[o]=n[o];if("function"==typeof e)i=e;
            else if(e)for(var o in e)s[o]=e[o];return s.html=t,i&&(s.cb=i),this.queue.push(s),this._run(),this
        },
        spawn:function(t){
            var e=this;
